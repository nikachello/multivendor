...
export const marketTheme: ThemeDefinition = {
  id: "market",
  name: "Market",
  description: "Colorful multi-category storefront with category pills and grid cards",
  thumbnail: "/themes/market-thumb.jpg",
  sections: {
