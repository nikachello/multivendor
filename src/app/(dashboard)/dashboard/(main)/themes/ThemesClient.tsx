    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 130% 120% at 80% 60%, #D9D2F2, #E7DCEF 40%, #F4ECE6)",
            minHeight: "56px",
          }}
        >
        ...
        <div className="px-3 pt-2 pb-1">
          <div
            className="h-2 w-16 mx-auto mb-2"
            style={{ background: "#2C2530", borderRadius: "2px" }}
          />
          <div className="grid grid-cols-4 gap-1">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex flex-col gap-1">
                ...
                />
                <div
                  className="h-[5px] w-3/4"
                  style={{ background: "#D7CDB9", borderRadius: "2px" }}
                />
              </div>
            ))}
          </div>
